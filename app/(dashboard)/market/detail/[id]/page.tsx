...
export default function DetailPage({ params }: DetailPageProps) {
  ...
  return (
    <div
      className=" h-[800px] p-4 mt-10 mx-10 rounded-3xl "
      style={{
    ...
    >
      <div className="flex p-1 bg-opacity-10 backdrop-blur-lg">
        ...
        <div className="p-2 flex-1  pt-10">
          <div className="text-3xl font-bold"> {detailData?.name || ''}</div>
